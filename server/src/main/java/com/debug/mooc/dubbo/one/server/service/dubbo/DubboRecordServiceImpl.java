...
@Path("record")
public class DubboRecordServiceImpl implements IDubboRecordService {

    private static final Logger log = LoggerFactory.getLogger(DubboRecordServiceImpl.class);
